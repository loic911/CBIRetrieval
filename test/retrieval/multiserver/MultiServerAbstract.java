...
public class MultiServerAbstract extends TestUtils{
    ...
    protected MultiServer multiServer;
    ...
    public void testIndexPictureAsynchrone() throws Exception {
        ...
        multiServer.indexPictureSynchrone(LOCALPICTURE3);
    ...
    public void testIndexPictureAsynchroneServer() throws Exception {
        ...
        multiServer.indexPictureAsynchrone(LOCALPICTURE3,CONTAINER1);    
    }
    ...
    public void testIndexPictureSynchroneServer() throws Exception {
        ...
        multiServer.indexPictureSynchrone(LOCALPICTURE3,CONTAINER1);
    ...
    public void testIndexDirectory() throws Exception{
        ...
        toDelete.add(LOCALPICTURE1);
        toDelete.add(LOCALPICTURE2);
        multiServer.delete(toDelete);
        
        File allPictures = new File(LOCALPICTUREPATH);
        int numberOfPictures = allPictures.listFiles().length;
        
        multiServer.indexDirectory(LOCALPICTUREPATH, new PictureAuthorization());
    ...
    public void testGetInfos() {
        ...
        assertEquals(2, multiServer.getInfos().get(CONTAINER1).size());
        assertEquals(0, multiServer.getInfos().get(CONTAINER2).size());
    }
}
