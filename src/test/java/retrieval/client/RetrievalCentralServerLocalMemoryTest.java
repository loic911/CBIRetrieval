 ...
 * @author lrollus
 */
public class RetrievalCentralServerLocalMemoryTest extends RetrievalCentralServerAbstract{
    
    private static Logger logger = Logger.getLogger(RetrievalCentralServerLocalMemoryTest.class);
