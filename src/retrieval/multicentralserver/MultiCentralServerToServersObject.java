...
public class MultiCentralServerToServersObject  {
     ...
     * Server list
     */
    private ListServerInformationObject listsServer;
     ...
     */
    public MultiCentralServerToServersObject(ListServerInformationObject listsServer) {
    ...
    public ResultsSimilarities searchMultiThread(List<ConcurrentHashMap<String, Long>> visualWords, int N, int k, String[] servers) throws InterruptedException {
        ...
        this.storages = (Map<String,Storage>)listsServer.getServers(servers);
