...
import retrieval.server.index.main.hashmap.MemoryHashTable;
import retrieval.server.index.main.hashmap.MemoryHashTableTest;
import retrieval.server.index.main.kyoto.KyotoCabinetHashTableMultipleFile;
import retrieval.server.index.main.kyoto.KyotoCabinetHashTableSingleFile;
...
public final class IndexStructClassic extends IndexStructAbs {
    ...
    public IndexStructClassic(String idStorage,String idTestVector, ConfigServer configStore, int testVector,Object database)
        ...
        } else if (configStore.getStoreName().equals(KyotoCabinetHashTableMultipleFile.NAME)) {
            //KYOTO MULTIPLE FILE (1 file for T vectors but n file for N servers)
            map = new KyotoCabinetHashTableMultipleFile((DB)database,idTestVector,configStore);
